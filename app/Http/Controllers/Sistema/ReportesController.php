        ...
        $html .= "
            <table width='100%' style='font-family:Arial, sans-serif; font-size:11px; border-collapse:collapse;'>
                ...
                <tr>
                    ...
                    <td></td>
                    <td style='text-align:center; font-size:12px; padding-top:6px;'>{$infoGeneral->nombre_firma_3}</td>
                </tr>
                <tr>
                    <td style='text-align:center; font-size:12px; font-weight:bold;'>{$infoGeneral->nombre_firma_2}</td>
                    <td></td>
                    <td style='text-align:center; font-size:12px; font-weight:bold;'>{$infoGeneral->nombre_firma_4}</td>
                </tr>
            </table>";
...
<table width='100%' style='border-collapse:collapse; font-family:Arial, sans-serif; font-size:11px;'>
    <thead>
        <tr>
            ...
            <th style='width:12%; border:0.8px solid #000; padding:5px 4px; text-align:center; background:#e8e8e8; font-size: 12px'>CANTIDAD</th>
            <th style='width:27%; border:0.8px solid #000; padding:5px 8px; text-align:center; background:#e8e8e8; font-size: 12px'>OBSERVACIONES</th>
        </tr>
    </thead>
    <tbody>";
        ...
        $html .= "
            <table width='100%' style='font-family:Arial, sans-serif; font-size:11px; border-collapse:collapse;'>
                ...
                <tr>
                    ...
                    <td></td>
                    <td style='text-align:center; font-size:12px; font-weight:bold;'>$salida->nombre_firma_4</td>
                </tr>
            </table>";
